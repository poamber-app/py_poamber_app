# Comment: Instantiates Environ object by setting its internal dictionary. 
Args:
...
# Comment: This function is deprecated, please use commandline instead
...
# Comment: This method is deprecated.  it is replaced by updates()
...
# Comment: Update override-able environ with values from overrides
...
# Comment: get environments files starting from path.
...
# Comment: find nodes to evaluate by walking the tree and fetching 
   environment files
...
# Comment: Gets the environment schema representing Path.
...
# Comment: First try replace, if not done or prefix_exlusive is False, do prefix_add
...
# Comment: Environ class is Accord way to manage environment variables.
...
# Comment: Update surce_map with override env variable.
...
# Comment: Builds environment dictionary out of node_files.
